...
export const MULTIPLICADOR_PERFIL: Record<NivelPerfil, number> = {
  A: 1,
  AA: 1.06,
  ELITE: 1.14,
};
...
export const BENCHMARK_EXTERNO_REFERENCIA = [
  { proveedor:"Allied Universal", plaza:"Monterrey", salario2026:20300, tarifa2026:39000, factor:1.9212 },
];

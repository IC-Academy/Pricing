...
export const OPCIONES_CATALOGO_COTIZACION:OpcionCatalogoCotizacion[] = [
  ...
  { id:"eq-oficina-otro", tipo:"EQUIPO", concepto:"Equipo de oficina", nombre:"Otro / Especifique", precioMensual:null, unidad:"MXN/mes", fuente:"Pendiente de catálogo Pricing", requiereValidacion:true },
